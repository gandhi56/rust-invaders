...
use crate::{GameTextures, WinSize, components::{Enemy, Movable, Velocity, SpriteSize, FromEnemy, Laser, Formation, FormationMaker}, SPRITE_SCALE, ENEMY_SIZE, EnemyCount, ENEMY_MAX, ENEMY_LASER_SIZE, TIME_STEP, BASE_SPEED};
...
fn enemy_movement_system(
  ...
  for (mut transform, mut formation) in query.iter_mut() {
      ...
      // fixtures
      let dir: f32 = if formation.start.0 < 0. { 1. } else { -1. }; // 1 is cw, -1 is ccw
